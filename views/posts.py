...
class PostListEndpoint(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            return Response(json.dumps({"message":"Error: please enter an integer"}), mimetype="application/json", status=400)
    ...
    def post(self):
        ...
        if not body.get('image_url'):
            return Response(json.dumps({"message": "Error: no image url found"}), mimetype="application/json", status=400)
        new_post = Post(
